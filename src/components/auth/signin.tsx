...
import { Brain, Sparkles, ArrowLeft, Shield, Zap, Users } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 text-gray-900 overflow-hidden relative">
      ...
      <div className="flex min-h-[calc(100vh-120px)] items-center justify-center px-4 relative z-10">
        <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              <h2 className="text-4xl font-bold mb-6 text-[#1F221F]">
                Welcome Back to Your AI Interview Coach
              </h2>
              <p className="text-xl text-gray-600 leading-relaxed">
                Continue your journey to interview mastery with personalized AI coaching and real-time feedback.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <motion.div
                ...
                className="flex items-center space-x-4 p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-100 hover:border-[#578CFF]/30 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <div className="p-3 bg-gradient-to-br from-[#578CFF] to-[#4A7AFF] rounded-xl">
                  <Zap className="h-6 w-6 text-white" />
                </div>
                <div>
                  <h3 className="font-semibold text-[#1F221F]">Instant AI Feedback</h3>
                  <p className="text-gray-600">Get real-time analysis of your responses</p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-[#1F221F]">Secure & Private</h3>
              ...
              >
                ...
                <div>
                  <h3 className="font-semibold text-[#1F221F]">Join 10K+ Users</h3>
                  <p className="text-gray-600">Part of a successful community</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
