...
export async function POST(req: NextRequest) {
  try {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: 'Interview Practice Session Scheduled',
      text: `Hello,

    Your interview practice session has been successfully scheduled.

    Details:
    - Interview Coach: ${counselorName}
    - Date: ${date}
    - Time: ${time}
